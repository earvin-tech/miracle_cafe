    ...
    return(
        <section className="max-w-6xl mx-auto px-4 py-16">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                {/* Coffee Info */}
                <div>
                    <h2 className="text-3xl font-semibold mb-4">Our Coffee Beans - The Harlequin Blend</h2>
                    ...
                    <a 
                        ...
                        className="inline-block bg-[#6B4F4F] text-white px-6 py-3 rounded-full hover:bg-[#4b3636] transition"
                    >
